    ...
    public static class DataSeeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            var riskManagements = new List<RiskManagement>
            {
                ...
                new RiskManagement { Id = 8, RiskCategory = "Frekans", RiskDescription = "Sık", RiskValue = 3.00m, CreatedDate = DateTime.Now, IsActive = true },
                ...
                new RiskManagement { Id = 13, RiskCategory = "Frekans", RiskDescription = "Beklenir, kesin", RiskValue = 10.00m, CreatedDate = DateTime.Now, IsActive = true },
